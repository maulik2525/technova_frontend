...
export default function Home() {
  ...
  return (
    <main className=" bg-white ">
      <section className="relative w-full py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20 2x:py-24">
        <div className="relative z-10 max-w-[1480px] w-full px-5 mx-auto">
          <div className="flex items-center justify-center flex-wrap lg:flex-nowrap">
            <div className="w-auto lg:w-1/2">
              <div className="w-full rounded-3xl space-y-2.5 sm:space-y-3 md:space-y-3.5 lg:space-y-4 xl:space-y-5">
                <div className="flex items-center space-x-2 zoom-in-zoom-out1">
                  <p className="bg-[#2aceb6] w-10 md:w-12 lg:w-14 h-0.5"></p>
                  <span className="text-md md:text-lg font-semibold text-[#2aceb6] tracking-wider montserrat">Welcome</span>
                </div>
            ...
            <div className="relative w-auto lg:w-1/2 mx-auto md:mx-0 mt-5 sm:mt-7 lg:mt-0">
              <div className="relative w-fit p-5 xl:p-6 mx-auto ">
                <div className="relative p-5 xl:p-6">
                    <img src="/banner.png" alt=""className="w-full h-full object-fill mx-auto"/>
                </div>
              </div>
      ...
      <section className="w-full bg-black py-10 sm:py12 md:py-14 lg:py-16 xl:py-20 2xl:py-24">
        <div className="max-w-[1480px] w-full px-5 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6 md:gap-7 lg:gap-8 xl:gap-9 2xl:gap-10 mt-8 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16">
            <div className="size-[270px] sm:size-[380px] md:size-[390px] xl:size-[410px] bg-blue-50 text-black text-center p-4 sm:p-5 md:p-6 lg:p-8 xl:p-10 2xl:p-12 mx-auto rainbow">
      ...
      <section className="w-full bg-[#2a4862] py-10 sm:py12 md:py-14 lg:py-16 xl:py-20 2xl:py-24">
        <div className="max-w-[1480px] w-full px-5 mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:ext-4xl 2xl:text-5xl font-semibold lg:font-bold text-white mt-3 sm:mt-4 lg:mt-5">We Provide Awesome Bloging</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 mt-8 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16 2xl:mt-20">

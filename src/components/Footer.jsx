            ...
            <div className="flex justify-between flex-wrap gap-6 lg:gap-8 xl:gap-10">
              ...
              <div className="">
                ...
                <Footer.LinkGroup col>
                  ...
                  <Footer.Link href="/CreatePost" className="text-sm lg:text-base font-medium text-white montserrat hover:text-teal-500">New Blog</Footer.Link>
                  <Footer.Link href="/Search" className="text-sm lg:text-base font-medium text-white montserrat hover:text-teal-500">Official Blog</Footer.Link>
                </Footer.LinkGroup>
              </div>
